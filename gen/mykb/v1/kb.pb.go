...
const file_mykb_v1_kb_proto_rawDesc = "" +
	...
	"\x10chunks_processed\x18\x05 \x01(\x05R\x0fchunksProcessed\"\xb7\x01\n" +
	...
	"\x16DeleteDocumentResponse2\xf6\x02\n" +
	"\tKBService\x12A\n" +
	"\tIngestURL\x12\x19.mykb.v1.IngestURLRequest\x1a\x17.mykb.v1.IngestProgress0\x01\x126\n" +
...
var file_mykb_v1_kb_proto_goTypes = []any{
	...
	(*QueryResponse)(nil),          // 3: mykb.v1.QueryResponse
	(*QueryResult)(nil),            // 4: mykb.v1.QueryResult
	(*Document)(nil),               // 5: mykb.v1.Document
	(*ListDocumentsRequest)(nil),   // 6: mykb.v1.ListDocumentsRequest
	(*ListDocumentsResponse)(nil),  // 7: mykb.v1.ListDocumentsResponse
	(*GetDocumentsRequest)(nil),    // 8: mykb.v1.GetDocumentsRequest
	(*GetDocumentsResponse)(nil),   // 9: mykb.v1.GetDocumentsResponse
...
var file_mykb_v1_kb_proto_depIdxs = []int32{
	...
	2,  // 4: mykb.v1.KBService.Query:input_type -> mykb.v1.QueryRequest
	6,  // 5: mykb.v1.KBService.ListDocuments:input_type -> mykb.v1.ListDocumentsRequest
	8,  // 6: mykb.v1.KBService.GetDocuments:input_type -> mykb.v1.GetDocumentsRequest
	10, // 7: mykb.v1.KBService.DeleteDocument:input_type -> mykb.v1.DeleteDocumentRequest
	1,  // 8: mykb.v1.KBService.IngestURL:output_type -> mykb.v1.IngestProgress
	3,  // 9: mykb.v1.KBService.Query:output_type -> mykb.v1.QueryResponse
	7,  // 10: mykb.v1.KBService.ListDocuments:output_type -> mykb.v1.ListDocumentsResponse
	9,  // 11: mykb.v1.KBService.GetDocuments:output_type -> mykb.v1.GetDocumentsResponse
	11, // 12: mykb.v1.KBService.DeleteDocument:output_type -> mykb.v1.DeleteDocumentResponse
